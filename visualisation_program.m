...
participant = '3' % participant in {1,2,3} for day={1,2,3}; participant in {1,2} for day={6,7,8}}
activity = 'clapping'; % activity in {walking, clapping, jumping, falling, nothing, waving}
trial = '20' % For trial in {1..50}
...
% Note that for CSI(channel state info), usually just applying the abs is not enough [3].
